...
if opcion == "1":
    ...
    juli=fun_pro2("https://pokeapi.co/api/v2/pokemon-shape/",'results',"pokemon_species")
    list_pokeg=[]
    for j in range (len(juli)):
        list_pokeg.append(juli[j]['name'])
    #print(list_pokeg)
    ...
    jul=fun_pro2("https://pokeapi.co/api/v2/ability/",'results',"pokemon")
    list_pokeg=[]
    ...
    jul=fun_pro2("https://pokeapi.co/api/v2/pokemon-habitat/",'results',"pokemon_species")
    list_pokeg=[]
    #print(jul)
    for j in range (len(jul)):
        list_pokeg.append(jul[j]["name"])
     #print(list_pokeg)
